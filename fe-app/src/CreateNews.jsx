...
export default function CreateNews(){
    ...
    async function writeArticle (data){
        console.log(JSON.stringify({ "postedBy": user, "category": data, "tags": tags, "text": content, "title": title }));
        const requestOptions = {
          method: 'POST',
          headers: {  'Accept': 'application/json',
                      'Content-Type': 'application/json', },
          body: JSON.stringify({ "postedBy": user, "category": data, "tags": tags, "text": content, "title": title })};
